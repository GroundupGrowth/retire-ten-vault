...
const bullets = [
  'Why "retire in 10 years" is a math number, not a marketing numberand the exact conditions under which it works',
  "The three asset categories wealthy families actually hold (hint: not the three your 401(k) offers)",
  "How Barry evaluates a real estate deal in under 10 minutesthe same filter that kept him out of the worst deals of 2007",
  "What the wealthy do with their cash while they're waiting for the next opportunity",
  "The difference between passive income and income that pretends to be passiveand why most people own the second kind without knowing it",
  "The infrastructure piece most real estate investors don't haveand how it compounds the returns on everything else you own",
